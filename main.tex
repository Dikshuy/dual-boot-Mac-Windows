...
\begin{itemize}
    ...
    \begin{itemize}
        \item \textbf{Intel Macs:} Standard x86-64 version from \href{https://releases.ubuntu.com/focal/}{Ubuntu releases}
        \item \textbf{M-series Macs:} ARM64 version from \href{https://cdimage.ubuntu.com/releases/20.04.5/release/}{Ubuntu ARM releases}
    \end{itemize}
\end{itemize}
